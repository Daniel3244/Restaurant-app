...
UPDATE menu_item SET name_en = 'Coca-Cola', description_en = 'Small Coke.' WHERE name = 'Coca-Cola';
...
UPDATE menu_item SET name_en = 'Beef Burger + Coca-Cola + Fries', description_en = 'Combo meal.' WHERE name = 'Burger Wolowy + Coca-Cola + Frytki';
...
UPDATE menu_item SET name_en = 'Wrap + Sprite + Fries', description_en = 'Wrap combo with drink and fries.' WHERE name = 'Wrap + Sprite + Frytki';
UPDATE menu_item SET name_en = 'Sprite', description_en = 'Sprite soda.' WHERE name = 'Sprite';
